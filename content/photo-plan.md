...
手順ページには、水気を取る写真・道具・体高・くぼみの工程 2 枚・脚を開く写真・くぼみに置く写真・からだと大顎の固定 2 枚・腿節と脛節の写真 2 枚・跗節の写真 2 枚・触角を横と上から見る写真 2 枚・仕上げを前・横・後ろから見る写真 3 枚・乾燥・ラベル・軟化 2 方法・配置比較の 23 枠を置いた。
...
| card-intermediate | ガイド 02 | 形や色の異なる四体の甲虫標本を並べた写真 |
| card-adults | ガイド 03 | クワガタ標本と採集情報のラベル |
...
| antennae | beginner#antennae | 跗節と触角の高さを横から見る |
| antennae-overview | beginner#antennae | 跗節と触角を上から見た全体像 |
