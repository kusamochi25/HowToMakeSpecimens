...
const contactAvailability = '受付準備中';
export const contactStatus = `現在、${contactAvailability}です。`;
export const contactLinkLabel = `お問い合わせ（${contactAvailability}）`;
export const questionsLabel = '気になること';
export const homePreparationLabel = '家庭での準備';
export const navigation = [
  { label: 'はじめてつくる', href: 'beginner.html' },
  { label: 'もっとくわしく', href: 'intermediate.html' },
  { label: '大人・先生のために', href: 'adults.html' },
  { label: homePreparationLabel, href: 'softening.html' },
  { label: questionsLabel, href: 'beginner.html#questions' }
];
export const pages = [
  ...
  { slug: 'softening', label: `${homePreparationLabel}・軟化について`, description: '家庭で乾燥した甲虫から標本を作るための準備編。軟化の方法と状態を確認し、共通の制作手順へ進みます。' },
...
export const workflow = [
  ...
  { id: 'board-recess', label: '必要ならくぼみを作る', short: 'くぼみを作る' },
  { id: 'open-legs', label: '閉じた脚をひろげる', short: '脚をひろげる' },
  { id: 'place', label: '作業台に置く', short: '作業台に置く' },
